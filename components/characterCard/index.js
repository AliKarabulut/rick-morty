...
const CharacterCard = (props) => {
  ...
  return (
    <Link href={`/${id} `} prefetch={false}>
      <div className=" group relative bg-text rounded-lg shadow-lg p-4 mt-4 cursor-pointer transition duration-300 ease-in-out  hover:shadow-xl hover:scale-105">
        ...
        <div className="flex justify-center left-1/2 items-center absolute top-0 border-8 border-background2 shadow-md bg-background2 box-content rounded-full  w-10 h-10 translate-x-y">
          {" "}
          <Image
